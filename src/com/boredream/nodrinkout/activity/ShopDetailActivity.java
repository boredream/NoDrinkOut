...
public class ShopDetailActivity extends BaseActivity implements OnClickListener {
	...
	private void initView() {
		View view = ViewUtils.initTitleBack(this, "咖店详情", simpleOnClickListener);
		...
		iv_collect = (ImageView) include_item_shop_content.findViewById(R.id.iv_collect);
		tv_collect = (TextView) include_item_shop_content.findViewById(R.id.tv_collect);
	...
	private void setLikeState() {
		if(hasLiked) {
			iv_collect_bottom.setColorFilter(getResources().getColor(R.color.red));
